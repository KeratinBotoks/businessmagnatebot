...
class Config:
    ...
    ADMIN_IDS: List[int] = field(default_factory=lambda: list(map(int, os.getenv("ADMIN_IDS", "").split(','))) if os.getenv("ADMIN_IDS") else [])
    ...
    EVENTS_CONFIG: str = "configs/events.json"
    BONUSES_CONFIG: str = "configs/bonuses.json"
